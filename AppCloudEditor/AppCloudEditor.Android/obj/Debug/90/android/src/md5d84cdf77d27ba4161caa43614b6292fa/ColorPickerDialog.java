...
/** @hide */
	...
	public ColorPickerDialog (android.content.Context p0, boolean p1, android.content.DialogInterface.OnCancelListener p2)
	{
		super (p0, p1, p2);
		if (getClass () == ColorPickerDialog.class)
			mono.android.TypeManager.Activate ("MonoDroid.ColorPickers.ColorPickerDialog, TEditor", "Android.Content.Context, Mono.Android:System.Boolean, mscorlib:Android.Content.IDialogInterfaceOnCancelListener, Mono.Android", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public ColorPickerDialog (android.content.Context p0, int p1)
	{
		super (p0, p1);
		if (getClass () == ColorPickerDialog.class)
			mono.android.TypeManager.Activate ("MonoDroid.ColorPickers.ColorPickerDialog, TEditor", "Android.Content.Context, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
