...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TEditor.TEditorWebViewClient, TEditor", TEditorWebViewClient.class, __md_methods);
	}
	...
	public TEditorWebViewClient ()
	{
		...
		if (getClass () == TEditorWebViewClient.class)
			mono.android.TypeManager.Activate ("TEditor.TEditorWebViewClient, TEditor", "", this, new java.lang.Object[] {  });
	}
